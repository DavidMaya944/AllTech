...
public class Producto implements Serializable {
	...
	public Producto(String sNombre, int iOpcion, String sComents, boolean bFragil, boolean bObsoleto, int iStockActual,
			int iStockMin, int iStockMax, String sProveedor, float fPVP) {
		setsNombre(sNombre);
		setiOpcion(iOpcion);
		setsComents(sComents);
		setbFragil(bFragil);
